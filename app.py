...
Откриващ текст: 
[Кратко и ясно, едно вдъхновяващо изречение и основните параметри на имота (напр. площ, цена, локация, обзавеждане – представени стегнато с емотикони).]
Финансов блок: 
...
**Финансов блок:** ✨ Този имот може да бъде закупен на разсрочено плащане чрез Банков Ипотечен Кредит с месечна вноска от {form_data['installment']} €.\n🔓Без начален капитал, без доказани доходи или с влошена кредитна история – ние съдействаме за успешно банково финансиране.\n📌 Финансирането не е пречка – то е част от решението.
**Описание на имота:**
[Подробно описание на {form_data['property_type']}, неговото разпределение, състояние, екстри и ключови подобрения. Започни тази секция с кратко резюме на основните параметри: Площ: {form_data['area']} кв.м | Цена: {form_data['price']} € | Локация: {form_data['location']} | Обзавеждане: {form_data['furnishing']} . AI ще интегрира и визуално откритите предимства от снимките.]
