...
[Текст, който подчертава удобствата и привлекателността на квартала/района, базиран на въведените данни (напр. 🌊 близост до плаж, 🌳 паркове, 🛍️ магазини, 🏫 училища, 🚌 транспорт, 🧘‍♀️ спокойствие).]
Допълнително:
[Включи всички други важни, но незадължителни характеристики, въведени от брокера (напр. 📦 включено мазе, 🧱 тухлена сграда, 🏢 етаж, 🅿️ опция за гараж).]
Защо с 360ESTATE?:
...
"""
        ...
        if hasattr(response.choices[0].message, 'content') and response.choices[0].message.content is not None:
            ...
            print("DEBUG ERROR: OpenAI response message content is missing or None.")
            full_generated_text = "Грешка: AI не върна съдържание."
